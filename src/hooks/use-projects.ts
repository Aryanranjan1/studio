 ...
 * This query is safe to use anywhere as it's filtered by 'published: true',
 * which passes the guard in `useCollection`.
 */
 ...
 * It uses onSnapshot directly to bypass the safety guard in useCollection, as it's
 * intended for a trusted admin context.
