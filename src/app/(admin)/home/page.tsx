                ...
                <Card className="col-span-12 lg:col-span-4">
                    ...
                    <CardContent className="space-y-4 text-sm">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Button asChild variant="link" size="sm" className="p-0 h-auto"><a href="/sitemap.xml" target="_blank">View Live</a></Button>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="flex items-center"><Bot className="mr-2 h-4 w-4" /> robots.txt</span>
                            <Button asChild variant="link" size="sm" className="p-0 h-auto"><a href="/robots.txt" target="_blank">View Live</a></Button>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="flex items-center"><Bot className="mr-2 h-4 w-4" /> llms.txt</span>
                            <Button asChild variant="link" size="sm" className="p-0 h-auto"><a href="/llms.txt" target="_blank">View Live</a></Button>
                        </div>
