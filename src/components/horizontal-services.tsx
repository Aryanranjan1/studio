...
const CtaCard = () => (
    <div className="w-full md:w-[50vw] h-[75vh] flex-shrink-0 flex flex-col items-center justify-center p-8 border-b md:border-b-0 md:border-r border-border bg-secondary text-secondary-foreground text-center">
