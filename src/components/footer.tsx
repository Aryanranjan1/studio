  ...
  return (
    <footer className="w-full bg-background text-foreground">
      ...
      <div className="relative h-72 w-full">
        ...
        />
        <div className="absolute inset-0 flex flex-col items-stretch justify-end bg-primary/90 p-4">
            <h2 className="text-black font-extrabold text-7xl md:text-9xl lg:text-[12rem] tracking-widest uppercase leading-none text-left">
                Ampire
            </h2>
        </div>
      </div>
